...
namespace JujutsuGameplayTags
{
	...
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_E);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_R);
	...
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Character_Event_Teleport_Back);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Character_Event_Teleport_Front);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Character_Event_Teleport_Right);
	...
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_A);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_A_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_A_Sukuna);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_E);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_E_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_E_Sukuna);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_R);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_R_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_R_Sukuna);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_ER);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_ER_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Sound_ER_Sukuna);

	/** GameplayCue.Effect (부모. Light, Heavy, Special → 각 하위 Gojo/Sukuna) */
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Light);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Light_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Light_Sukuna);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Heavy);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Heavy_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Heavy_Sukuna);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Special);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Special_Gojo);
	JUJUTSU_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Effect_Special_Sukuna);
}
